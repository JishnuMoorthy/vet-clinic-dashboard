...
serve(async (req) => {
  ...
  try {
    ...
    const pets = [
      ...
      { id: P.p5, clinic_id: CLINIC_ID, owner_id: O.o3, name: "Tiger", species: "Dog", breed: "German Shepherd", gender: "male", date_of_birth: "2020-11-22", weight_kg: 35.0, color: "Black & Tan", health_status: "under_treatment", microchip_id: "IN-900-003-456-789" },
      ...
      { id: P.p16, clinic_id: CLINIC_ID, owner_id: O.o11, name: "Cookie", species: "Dog", breed: "Cocker Spaniel", gender: "female", date_of_birth: "2022-10-08", weight_kg: 11.0, color: "Golden", health_status: "under_treatment" },
